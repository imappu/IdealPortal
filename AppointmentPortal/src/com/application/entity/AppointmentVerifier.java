...
@NamedNativeQueries({
		...
		@NamedNativeQuery(name = "appoint", query = "select * from AppointmentRegister", resultClass = AppointmentVerifier.class)

})
*/

public class AppointmentVerifier {
	...
	public AppointmentVerifier(String department, String doctorname, int employeeid, String bookeddate, String slot01,
